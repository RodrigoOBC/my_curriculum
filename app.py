...
def index(lang='pt'):
    ...
    return render_template('index.html', personal_data=personal_data, lang=lang)
...
def education(lang='pt'):
    ...
    return render_template('education.html',data=education, personal_data=personal_data,heading=heading, lang=lang)
...
def projects():
    ...
    return render_template('articles.html',data=articles,personal_data=personal_data, lang=lang)
...
def repositories():
    ...
    return render_template('repository.html',data=repositories,personal_data=personal_data,  lang=lang)
