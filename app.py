...
@app.route('/<lang>/')
def index(lang='pt'):
    personal_data_all = language_processor.get_json("static/data/personal_data.json")
    personal_data = language_processor.get_language_json(personal_data_all, lang)
...
def education(lang='pt'):
    personal_data_all = language_processor.get_json("static/data/personal_data.json")
    personal_data = language_processor.get_language_json(personal_data_all, lang)
    education_all = language_processor.get_json("static/data/profissional_skills_data.json")
...
def work(lang='pt'):
    personal_data_all = language_processor.get_json("static/data/personal_data.json")
    personal_data = language_processor.get_language_json(personal_data_all, lang)
    work_all = language_processor.get_json("static/data/profissional_skills_data.json")
...
def repositories(lang='pt'):
    personal_data_all = language_processor.get_json("static/data/personal_data.json")
    personal_data = language_processor.get_language_json(personal_data_all, lang)
    repositories_all = language_processor.get_json("static/data/repositories.json")
